      ...
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-2xl overflow-hidden border border-blue-200">
        <div className="bg-blue-600 px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="bg-blue-800 text-white text-xs font-bold px-3 py-1 rounded-full inline-flex shadow-sm">
              {registros.length} Items
            </span>
            <button
              onClick={() => setIsModalOpen(true)}
              className="bg-white text-blue-600 hover:bg-blue-50 font-bold py-2 px-4 rounded-lg shadow-md transition-all flex items-center gap-2 text-sm cursor-pointer"
            >
            ...
            {!isAdmin && (
              <Link
                to="/login"
                className="bg-transparent text-white hover:bg-blue-700 font-bold py-2 px-4 rounded-lg shadow-sm border border-blue-400 transition-all flex items-center gap-2 text-sm cursor-pointer"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
